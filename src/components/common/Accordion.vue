<template>
  <div class="accordion" :style="{'margin-top':cascade?'-1px':''}">
    ...
    <mt-cell :style="{height:ready&&expand?$refs.content.clientHeight+'px':'1px','min-height':ready&&expand?$refs.content.clientHeight+'px':'1px','-webkit-transition':animation?'all .2s ease-out':''}">
